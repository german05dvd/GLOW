  ...
  return (
    ...
    >
      <Icon
        ...
        style={{ color: logo.tint === "text-accent-brand" ? "oklch(0.50 0.085 142)" : logo.tint === "text-foreground" ? "oklch(0.18 0.022 62)" : "oklch(0.46 0.022 70)" }}
        strokeWidth={1.2}
      />
    </motion.div>
  );
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center pt-2">
        ...
        <motion.div
          style={{ scaleY: barScale, backgroundColor: "oklch(0.50 0.085 142)" }}
      ...
      <div className="sticky top-0 flex h-screen w-full items-center overflow-hidden">
        <div className="mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-10 px-8 md:grid-cols-[1fr_1.4fr] md:px-12 lg:px-16">
          ...
          <div>
            ...
            >
              Tu marca,{" "}
              <span style={{ color: "oklch(0.50 0.085 142)" }}>paso a paso.</span>
            </h2>
          ...
          <div className="relative h-[70vh] w-full">
            ...
            <div
              ...
              style={{ backgroundColor: "oklch(0.50 0.085 142 / 0.12)" }}
            />
          </div>
        </div>
      </div>
